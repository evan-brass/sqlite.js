...
/**
 * Convert #defines in vendor/sqlite3.h into exported constants in dist/sqlite_def.js
 */
export async function build() {
	// Convert #defines in sqlite3.h into exported constants in sqlite_def.js (Remember to check the output of this function whenever doing a vendor update)
	...
	const sqlite_def = await Deno.open('dist/sqlite_def.js', {write: true, create: true});
	...
	await sqlite3_h.readable
		...
		// Parse each line for defines that match what we want in sqlite_def.js
